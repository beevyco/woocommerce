...
class WC_Admin_Setup_Wizard {
	...
	public function wc_setup_ready() {
		...
		$help_text    = sprintf(
			...
			__( 'Watch the <a href="%1$s" target="_blank">guided tour videos</a> to learn more about WooCommerce.', 'woocommerce' ),
			$videos_url,
			$docs_url
		);
		?>
		...
		<ul class="wc-wizard-next-steps">
			...
			<li class="wc-wizard-next-step-item" style="display:none;">
				<div class="wc-wizard-next-step-description">
